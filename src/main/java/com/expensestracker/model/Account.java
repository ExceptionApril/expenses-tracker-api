...
public class Account {
    ...
    public Account(Long accountId, User user, String accountName, AccountType accountType, BigDecimal balance, LocalDateTime createdAt) {
    ...
    public static class AccountBuilder {
        ...
        public Account build() {
            return new Account(accountId, user, accountName, accountType, balance, createdAt);
        }
    }
